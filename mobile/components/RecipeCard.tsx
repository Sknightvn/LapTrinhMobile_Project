  ...
  return (
    ...
    >
      <View style={recipeCardStyles.imageContainer}>
        <Image
          source={recipe?.image ? { uri: recipe.image } : require("../assets/images/lamb.png")}
          style={recipeCardStyles.image}
          contentFit="cover"
          transition={300}
          onError={(e) => console.warn('[RecipeCard] Image load error', recipe?.id, (e as any)?.nativeEvent || e)}   
        />
      </View>
